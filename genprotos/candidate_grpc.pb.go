...
type CandidateServiceClient interface {
	CreateCandidate(ctx context.Context, in *Candidate, opts ...grpc.CallOption) (*Void, error)
...
func (c *candidateServiceClient) CreateCandidate(ctx context.Context, in *Candidate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/protos.CandidateService/CreateCandidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *candidateServiceClient) DeleteCandidate(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/protos.CandidateService/DeleteCandidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *candidateServiceClient) UpdateCandidate(ctx context.Context, in *Candidate, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/protos.CandidateService/UpdateCandidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *candidateServiceClient) GetByIdCandidate(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Candidate, error) {
	out := new(Candidate)
	err := c.cc.Invoke(ctx, "/protos.CandidateService/GetByIdCandidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CandidateServiceServer interface {
	CreateCandidate(context.Context, *Candidate) (*Void, error)
...
func (UnimplementedCandidateServiceServer) CreateCandidate(context.Context, *Candidate) (*Void, error) {
...
func _CandidateService_CreateCandidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.CandidateService/CreateCandidate",
	}
...
func _CandidateService_DeleteCandidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.CandidateService/DeleteCandidate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CandidateService_UpdateCandidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.CandidateService/UpdateCandidate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CandidateService_GetByIdCandidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.CandidateService/GetByIdCandidate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
