...
type PublicVoteServiceClient interface {
	CreatePublicVote(ctx context.Context, in *PublicVote, opts ...grpc.CallOption) (*Void, error)
...
func (c *publicVoteServiceClient) CreatePublicVote(ctx context.Context, in *PublicVote, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
...
type PublicVoteServiceServer interface {
	CreatePublicVote(context.Context, *PublicVote) (*Void, error)
...
func (UnimplementedPublicVoteServiceServer) CreatePublicVote(context.Context, *PublicVote) (*Void, error) {
